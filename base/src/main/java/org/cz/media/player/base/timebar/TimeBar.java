...
public interface TimeBar {
  ...
  boolean isBeginFakeSeek();
  /**
   * This function cooperate with the fake seek. And it only work when user start fake seek.
   * On the contrary, The function {@link #setPosition(long)} only work when user not fake seek.
   * @param position
   */
   ...
   */
  void setMarkGroupTimesMs(@Nullable long[] adGroupTimesMs, @Nullable boolean[] playedAdGroups,
                           int adGroupCount);

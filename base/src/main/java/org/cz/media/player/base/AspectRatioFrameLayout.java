...
public final class AspectRatioFrameLayout extends FrameLayout {
  ...
  // LINT.IfChange
  /**
   * Resize modes for {@link org.cz.media.player.base.AspectRatioFrameLayout}. One of {@link #RESIZE_MODE_FIT}, {@link
  ...
  @ResizeMode private int resizeMode=RESIZE_MODE_FIT;
  ...
  public void setAspectRatio(float widthHeightRatio) {
    if (this.videoAspectRatio != widthHeightRatio) {
      ...
      requestLayout();
      Log.i(TAG,"setAspectRatio:"+widthHeightRatio);
    }
  }
  ...
  protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    ...
    Log.i(TAG,"onMeasure:"+hashCode()+" measuredWidth:"+measuredWidth+" measuredHeight:"+measuredHeight);
  }

  @Override
  protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
    super.onLayout(changed, left, top, right, bottom);
    Log.i(TAG,"onLayout:"+hashCode()+" videoAspectRatio:"+videoAspectRatio+" left:"+left+" top:"+top+" right:"+right+" bottom:"+bottom);
  }
